            ...
            var e = t(this),
                ...
                a = function() {
                    var t = [],
                        ...
                        a = e.text(),
                        r = /[0-9]+,[0-9]+/.test(a);
                    a = a.replace(/,/g, ""), /^[0-9]+$/.test(a);
                    for (var c = /^[0-9]+\.[0-9]+$/.test(a), o = c ? (a.split(".")[1] || []).length : 0, d = n; d >= 1; d--) {
                        var i = parseInt(a / n * d);
                        if (c && (i = parseFloat(a / n * d).toFixed(o)), r)
                            for (;
                    ...
                    e.data("counterup-func", f), setTimeout(e.data("counterup-func"), u.delay)
                };
            e.waypoint(a, {
                offset: "100%",
                triggerOnce: !0
