...
<!--
 ...
 / Version: 1.0.0
 / Developed on 2024-01-24 16:03:04
                    ...
                    <div class="col-xl-6">
                        <div class="copyright">
                            <p>© Copyright
                                ...
                                <a href="add-card.html#">Ekash</a> I All Rights Reserved
                            </p>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="footer-social">
                            <ul>
                                <li><a href="add-card.html#"><i class="fi fi-brands-facebook"></i></a></li>
                                <li><a href="add-card.html#"><i class="fi fi-brands-twitter"></i></a></li>
                                <li><a href="add-card.html#"><i class="fi fi-brands-linkedin"></i></a></li>
                                <li><a href="add-card.html#"><i class="fi fi-brands-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
